...
import static com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.VpnProfile.EXTRA_PROFILEUUID;
import static com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.VpnProfile.EXTRA_PROFILE_VERSION;
import static com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.core.ConnectionStatus.LEVEL_CONNECTED;
import static com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.core.ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT;
import static com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.core.NetworkSpace.IpAddress;
...
import com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.LaunchVPN;
import com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.R;
import com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.VpnProfile;
//import com.example.vpnapp.api.ExternalAppDatabase;

import com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.core.VpnStatus.ByteCountListener;
import com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.core.VpnStatus.StateListener;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    public static final String START_SERVICE = "com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.START_SERVICE";
    public static final String START_SERVICE_STICKY = "com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.NOTIFICATION_ALWAYS_VISIBLE";

    public static final String EXTRA_DO_NOT_REPLACE_RUNNING_VPN = "com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.DO_NOT_REPLACE_RUNNING_VPN";

    public static final String EXTRA_START_REASON = "com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.startReason";

    public static final String DISCONNECT_VPN = "com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.DISCONNECT_VPN";
    ...
    public static final String EXTRA_CHALLENGE_TXT = "com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.core.CR_TEXT_CHALLENGE";
    public static final String EXTRA_CHALLENGE_OPENURL = "com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.core.OPENURL_CHALLENGE";
    private static final String PAUSE_VPN = "com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.PAUSE_VPN";
    private static final String RESUME_VPN = "com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.RESUME_VPN";
...
//        return extapps.checkRemoteActionPermission(this, packagename);
    ...
    private void showNotification(final String msg, String tickerText, @NonNull String channel, long when, ConnectionStatus status, Intent intent) {
        ...
        if (when != 0){
            ...
            Intent localBroadcast = new Intent("com.example.UPDATE_TIME");
            localBroadcast.putExtra("elapsedTime", elapsedTime);
...
//            nbuilder.setContentTitle(getString(R.string.notifcation_title, mProfile.mName));
    ...
    private int getIconByConnectionStatus(ConnectionStatus level) {
        switch (level) {
            case LEVEL_CONNECTED:
                return R.drawable.ic_icon_system;
    ...
    private void addVpnActionsToNotification(Notification.Builder nbuilder) {
        ...
        nbuilder.addAction(R.drawable.ic_baseline_close_24,
...
//                    getString(R.string.resumevpn), resumeVPNPending);
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class<?> cl = Class.forName("com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.core.OpenVPNThreadv3");
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.VPN_STATUS");
