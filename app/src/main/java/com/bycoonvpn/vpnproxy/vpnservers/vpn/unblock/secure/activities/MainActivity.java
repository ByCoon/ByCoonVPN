...
public class MainActivity extends AppCompatActivity implements Handler.Callback {
    ...
    private void exitDialog(){
        new MaterialAlertDialogBuilder(MainActivity.this,R.style.Custom)
                .setTitle("Exit App")
                .setMessage("Are you sure you want to exit Nos VPN?")
    ...
    private void rationaleDialog(){
        new MaterialAlertDialogBuilder(MainActivity.this,R.style.Custom)
                ...
                .setMessage("We need Notifications permission for working of Nos VPN. Please consider granting this permission.")
    ...
    private void settingsDialog(){
        new MaterialAlertDialogBuilder(MainActivity.this,R.style.Custom)
                .setTitle("Permission Required")
                .setMessage("We need Notifications permission for working of Nos VPN. Please grant this permission from app settings screen.")
