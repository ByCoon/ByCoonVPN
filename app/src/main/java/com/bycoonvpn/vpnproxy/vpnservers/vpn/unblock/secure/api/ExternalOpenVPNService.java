...
package com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.api;
...
import com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.core.ConfigParser;
import com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.core.ConfigParser.ConfigParseError;
import com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.core.ConnectionStatus;
import com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.core.IOpenVPNServiceInternal;
...
public class ExternalOpenVPNService extends Service implements StateListener {
    ...
    private static final String EXTRA_INLINE_PROFILE_ALLOW_VPN_BYPASS = "com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.api.ALLOW_VPN_BYPASS";
...
//            mExtAppDb.checkOpenVPNPermission(getPackageManager());
        ...
        private void startProfile(VpnProfile vp)
        {
            ...
            if(vpnPermissionIntent != null || neddPassword != 0){
                Log.e("VPNMY", "startProfile: first time");
                ...
                Log.e("VPNMY", "startProfile: second time");
