...
import com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.core.IServiceStatus;
import com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.core.OpenVPNStatusService;
...
import com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.core.ProfileManager;
import com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.core.VPNLaunchHelper;
...
public class LaunchVPN extends Activity {
    public static final String EXTRA_KEY = "com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.shortcutProfileUUID";
    public static final String EXTRA_NAME = "com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.shortcutProfileName";
    public static final String EXTRA_HIDELOG = "com.bycoonvpn.vpnproxy.vpnservers.vpn.unblock.secure.showNoLogWindow";
...
//        mSelectedProfile.mUsername = "freeopenvpn";
//        mSelectedProfile.mPassword = null;
//        mTransientAuthPW = "";
//        mTransientCertOrPCKS12PW = "";
...
//        handler.postDelayed(runnable, 1000);
        ...
        if (type == R.string.password) {
            ...
            ((CheckBox) userpwlayout.findViewById(R.id.show_password)).setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (isChecked)
