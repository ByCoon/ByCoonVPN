...
extern "C" jstring Java_com_bycoonvpn_vpnproxy_vpnservers_vpn_unblock_secure_core_NativeUtils_getOpenSSLVersionString(JNIEnv *env, jclass jo)
{
...
extern "C" jbyteArray Java_com_bycoonvpn_vpnproxy_vpnservers_vpn_unblock_secure_core_NativeUtils_rsapss(JNIEnv *env,
								     jclass,
								     jint hashtype,
								     jint MSBits,
								     jint rsa_size,
