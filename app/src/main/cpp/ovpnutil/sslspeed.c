...
jdoubleArray Java_com_bycoonvpn_vpnproxy_vpnservers_vpn_unblock_secure_core_NativeUtils_getOpenSSLSpeed(JNIEnv* env, jclass thiz, jstring algorithm, jint testnumber)
{
